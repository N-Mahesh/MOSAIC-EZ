...
EXPECTED_FILES = frozenset({
    ...
    "manuscript/generated_cifair_validation.tex", "manuscript/generated_utility_study.tex", "manuscript/urtc2026.pdf",
    "claims/public_cifair_validation_results.v1.json", "claims/public_cifair_claim_ledger.v1.json",
    "claims/aggregate_utility_study.v1.json",
    ...
    "validation/aggregate_utility_study.py",
    "tests/test_public_cifair_validation.py", "tests/test_split_risk_theorem.py",
    "tests/test_aggregate_utility_study.py",
})
