...
https://github.com/N-Mahesh/MOSAIC-EZ/tree/urtc2026-cifair-v10
...
Success ends with `PASS: exact public reproduction bundle verified.` Any manifest, PDF, checksum, schema, frozen-claim, macro, ledger, utility-study, metadata, source-rebuild, or test mismatch exits nonzero. The bundle contains no CIFAR images or upstream annotation CSVs, so full empirical reproduction is explicitly network-dependent.
