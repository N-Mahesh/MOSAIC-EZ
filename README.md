...
https://github.com/N-Mahesh/MOSAIC-EZ/tree/urtc2026-cifair-v8

Verified environment: Python 3.12.5 and pypdf 6.14.2. The analysis itself uses only the Python standard library. Expected full verification time is under two minutes on a typical laptop. Git and network access are required only for retrieving the pinned upstream metadata used by the full check.

Environment bootstrap and quick integrity, PDF, claim-ledger, and unit-test check:
